...
def register_default_envs(env_registry):
    ...
    def dmlab_funcs():
        ...
        from envs.dmlab.dmlab_params import add_dmlab_env_args, dmlab_override_defaults
        return make_dmlab_env, add_dmlab_env_args, dmlab_override_defaults

    def mujoco_funcs():
        from envs.mujoco.mujoco_utils import make_mujoco_env
        from envs.mujoco.mujoco_params import add_mujoco_env_args, mujoco_override_defaults
        return make_mujoco_env, add_mujoco_env_args, mujoco_override_defaults

    def quadrotors_funcs():
        from envs.quadrotors.quad_utils import make_quadrotor_env
        from envs.quadrotors.quadrotor_params import add_quadrotors_env_args, quadrotors_override_defaults
        return make_quadrotor_env, add_quadrotors_env_args, quadrotors_override_defaults
