...
_experiment = Experiment(
    ...
    '--gamma=0.99 --use_rnn=False --num_workers=72 --num_envs_per_worker=4 --num_policies=8 --rollout=128 '
...
RUN_DESCRIPTION = RunDescription('quads_single_pbt_v102_v3', experiments=[_experiment])
